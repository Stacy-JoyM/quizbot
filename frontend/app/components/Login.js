    ...
    <div className="flex w-full min-h-screen relative">
      ...
      <div className="w-2/5 bg-gradient-to-br from-emerald-600 to-teal-600 p-12 flex flex-col justify-center text-white relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          {/* Heading */}
          <h2 className="text-4xl font-bold mb-4 leading-tight">Welcome<br/>to<br/>Quizbot!</h2>
          ...
          <div className="flex items-center gap-3 mb-6">
            <img src="https://i.pravatar.cc/150?img=5" alt="" className="w-12 h-12 rounded-full border-3 border-white shadow-lg" />
            <img src="https://i.pravatar.cc/150?img=6" alt="" className="w-12 h-12 rounded-full border-3 border-white shadow-lg" />
            <img src="https://i.pravatar.cc/150?img=7" alt="" className="w-12 h-12 rounded-full border-3 border-white shadow-lg" />
            <img src="https://i.pravatar.cc/150?img=8" alt="" className="w-12 h-12 rounded-full border-3 border-white shadow-lg" />
          </div>
        ...
        <div className="max-w-md mx-auto w-full">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-emerald-600 hover:bg-emerald-700 disabled:bg-slate-300 text-white font-semibold py-3 text-base rounded-lg transition-all shadow-md hover:shadow-lg disabled:cursor-not-allowed disabled:shadow-none"
            >
